...
public :
    CoreBox(float x, float y, float z) : Box( x,  y,  z, COREBOX_HEIGHT, COREBOX_WIDTH, COREBOX_DEPTH,  COREBOX_MASS,  computeInertia( COREBOX_MASS, COREBOX_CORERADIUS), COREBOX_COLOR){}
private :
