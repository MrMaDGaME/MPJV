...
public:
    ...
    virtual void checkObjectCollision(std::shared_ptr<IObject>& other, std::shared_ptr<ObjectCollisionRegistry>& collision_registry) = 0;
    virtual void checkParticleCollision(std::shared_ptr<Particle>& particle, std::shared_ptr<ObjectCollisionRegistry>& collision_registry) = 0;
};
