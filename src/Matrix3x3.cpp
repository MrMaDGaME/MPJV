...
{
    Matrix3x3 result;
    result(0, 0) = 1; result(0, 1) = 0; result(0, 2) = tx;
    result(1, 0) = 0; result(1, 1) = 1; result(1, 2) = ty;
...
Matrix3x3 Matrix3x3::rotate(const float angle)
{
    ...
    result(0, 0) = cos(rad); result(0, 1) = -sin(rad); result(0, 2) = 0;
    result(1, 0) = sin(rad); result(1, 1) = cos(rad); result(1, 2) = 0;
    result(2, 0) = 0; result(2, 1) = 0; result(2, 2) = 1;
    return result;
}
